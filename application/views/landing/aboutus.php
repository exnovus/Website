...
<?php
									/*<section class="main">
										...
										<div class="spotlights">
											<article>
												<div class="video">
													<iframe src="https://www.youtube.com/embed/qUuqUbYU3aA" frameborder="0" allowfullscreen></iframe>
												</div>
												<div class="content">
													<h3>Aliquam</h3>
											...
											<article>
												<div class="image"><img src="<?= base_url() ?>application/media/images/pic08.jpg" alt="" data-position="center" /></div>
												<div class="content">
													...
													<ul class="actions">
														<li><a href="#" class="button">Ver ofertas</a></li>
														<li><a href="#" class="button special">Conoce mas</a></li>
													</ul>
												</div>
											</article>
										</div>
